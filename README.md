...
<img width="266" alt="image" src="https://user-images.githubusercontent.com/43217465/196067932-8dafc30b-81de-4746-a416-593aa7a35110.png">. 
 ...
 The mobile app settings include the user's health settings that determine their daily hydration goal and the bottle cleaning status. When the user updates their weight and age group, their daily hydration goal will be calculatedand updated in both the mobile app and on the water bottle screen. On the left below is the component on the phone where you can edit and view your current health stats and hydration goal, and on the right is the daily hyrdation goal tracker on the water bottle:   
